    ...
    return(
        ...
        <div>
            <ul id="navbar">
                ...
                {/* Eventually create a page that explains what this site does and why. 
                For now, place a link that refreshes to index.html. */}
                <li><a href="index.html">About</a></li>


                {/* Eventually create a page that announces planned features for the web application. 
                For now, place a link that refreshes to index.html. */}
                <li><a href="index.html">Planned Features</a></li>
